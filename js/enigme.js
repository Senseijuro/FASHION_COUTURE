document.addEventListener('DOMContentLoaded', function() {
  ...
  var allQuestions = [
    {
      icon: '🧤',
      definition: 'Matière souple et résistante issue de la peau d\'animaux, transformée par tannage, utilisée pour fabriquer sacs, ceintures et portefeuilles.',
      answer: 'Le cuir',
      choices: ['Le cuir', 'La laine', 'Le caoutchouc', 'La soie']
    },
    {
      icon: '🔪',
      definition: 'Outil à lame fine et biseautée utilisé par le maroquinier pour couper proprement le cuir en tranches nettes.',
      answer: 'Le tranchet',
      choices: ['Le tranchet', 'Le maillet', 'L\'alène', 'Le réglet']
    },
    {
      icon: '👷',
      definition: 'Artisan qui fabrique à la main des articles en cuir comme des sacs, des portefeuilles, des ceintures et parfois des selles.',
      answer: 'Le maroquinier',
      choices: ['Le maroquinier', 'Le plombier', 'Le charpentier', 'Le bottier']
    },
    {
      icon: '🎓',
      definition: 'Diplôme de niveau 3 préparé en 2 ans, souvent en apprentissage, qui forme aux techniques de base de la confection en cuir.',
      answer: 'Le CAP Maroquinerie',
      choices: ['Le CAP Maroquinerie', 'Le BTS Design', 'Le Bac Pro Couture', 'La Licence Luxe']
    },
    {
      icon: '🪡',
      definition: 'Outil métallique pointu servant à perforer le cuir avant de passer le fil pour coudre les pièces ensemble.',
      answer: 'L\'alène',
      choices: ['L\'alène', 'Le gabarit', 'Le tranchet', 'La cisaille']
    },
    {
      icon: '🏭',
      definition: 'Processus chimique ou naturel qui transforme une peau brute d\'animal en cuir durable et utilisable par le maroquinier.',
      answer: 'Le tannage',
      choices: ['Le tannage', 'Le polissage', 'Le tressage', 'Le soudage']
    },
    {
      icon: '📐',
      definition: 'Modèle rigide utilisé comme guide pour tracer et découper les pièces de cuir toujours à la même forme et dimension.',
      answer: 'Le gabarit',
      choices: ['Le gabarit', 'Le maillet', 'Le fil de lin', 'La teinture']
    },
    {
      icon: '🐴',
      definition: 'Spécialité du maroquinier qui travaille les équipements pour les cavaliers : selles, étriers, brides et sangles.',
      answer: 'La sellerie',
      choices: ['La sellerie', 'La poterie', 'La joaillerie', 'La verrerie']
    },
    {
      icon: '🧵',
      definition: 'Fil naturel, souvent ciré, très solide, utilisé pour coudre le cuir à la main ou à la machine en maroquinerie traditionnelle.',
      answer: 'Le fil de lin',
      choices: ['Le fil de lin', 'La laine mohair', 'Le fil de fer', 'Le nylon élastique']
    },
    {
      icon: '💼',
      definition: 'Opération qui consiste à amincir le bord des pièces de cuir pour faciliter l\'assemblage et avoir un rendu soigné.',
      answer: 'Le parage',
      choices: ['Le parage', 'Le polissage', 'Le mordançage', 'Le gaufrage']
    }
  ];
  ...
  function handleChoice(choice, btn) {
    ...
    if (correct) {
      ...
      if (navigator.vibrate) navigator.vibrate([50]); // Vibration petite erreur
  ...
  function showResult(success, score) {
    ...
    if (success) {
      ...
      if (window.confetti) confetti({ particleCount: 150, spread: 80, origin: { y: 0.6 }, colors: ['#a855f7', '#c8a96e'] }); // Confettis violets/or
