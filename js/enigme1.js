document.addEventListener('DOMContentLoaded', function() {
  ...
  var allQuestions = [
    {
      cat: '🎓 Formation',
      q: 'Quel diplôme permet de devenir maroquinier après 2 ans de formation ?',
      answer: 'CAP Maroquinerie',
      choices: ['CAP Maroquinerie', 'BTS Luxe', 'Bac Pro Mode', 'Licence Cuir']
    },
    {
      cat: '🛠️ Outils',
      q: 'Comment s\'appelle l\'outil pointu qui perce les trous dans le cuir avant de coudre ?',
      answer: 'L\'alène',
      choices: ['L\'alène', 'Le tranchet', 'Le maillet', 'Le réglet']
    },
    {
      cat: '🏭 Secteur',
      q: 'Quelle grande maison française est réputée pour ses sacs en cuir fabriqués entièrement à la main ?',
      answer: 'Hermès',
      choices: ['Hermès', 'Renault', 'L\'Oréal', 'Michelin']
    },
    {
      cat: '🧵 Matières',
      q: 'Quelle matière est principalement travaillée par le maroquinier ?',
      answer: 'Le cuir',
      choices: ['Le cuir', 'La soie', 'Le béton', 'Le plastique']
    },
    {
      cat: '💼 Métier',
      q: 'Quel professionnel peut fabriquer à la fois des sacs, des ceintures ET des selles pour chevaux ?',
      answer: 'Le sellier-maroquinier',
      choices: ['Le sellier-maroquinier', 'Le styliste', 'Le bottier', 'Le tailleur']
    },
    {
      cat: '🏭 Conditions',
      q: 'Dans quel type de structure travaille principalement un maroquinier artisanal ?',
      answer: 'Un atelier',
      choices: ['Un atelier', 'Un hôpital', 'Un chantier naval', 'Une école']
    },
    {
      cat: '🛠️ Techniques',
      q: 'Comment appelle-t-on l\'action de coudre les pièces de cuir ensemble en maroquinerie ?',
      answer: 'Le piquage',
      choices: ['Le piquage', 'Le tressage', 'Le soudage', 'Le tricotage']
    },
    {
      cat: '🎓 Débouchés',
      q: 'Où un maroquinier diplômé peut-il travailler en dehors des ateliers artisanaux ?',
      answer: 'En manufacture de luxe',
      choices: ['En manufacture de luxe', 'En pharmacie', 'En boulangerie', 'En mécanique auto']
    },
    {
      cat: '🧵 Matières',
      q: 'Quel fil résistant et ciré est traditionnellement utilisé pour coudre le cuir ?',
      answer: 'Le fil de lin',
      choices: ['Le fil de lin', 'La laine', 'Le nylon fin', 'La ficelle de jute']
    },
    {
      cat: '💼 Métier',
      q: 'Quelle qualité est INDISPENSABLE pour exercer le métier de maroquinier ?',
      answer: 'La dextérité manuelle',
      choices: ['La dextérité manuelle', 'La force physique', 'La rapidité de frappe', 'Le sens de la musique']
    }
  ];
  ...
  function handleTimeout() {
    answered = true;
    wrongCount++;
    if (navigator.vibrate) navigator.vibrate([50, 50, 50]); // Vibration temps écoulé
  ...
  function showResult(success, score) {
    ...
    if (success) {
      ...
      if (window.confetti) confetti({ particleCount: 150, spread: 80, origin: { y: 0.6 }, colors: ['#c8a96e', '#00d4ff'] }); // Confettis or/cyan
      ...
      if (resultBox) {
        ...
        void resultBox.offsetWidth; // Force l'animation
